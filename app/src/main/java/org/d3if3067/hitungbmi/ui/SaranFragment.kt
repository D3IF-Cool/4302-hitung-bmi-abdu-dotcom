...
import org.d3if3067.hitungbmi.databinding.FragmentSaranBinding
    ...
    private fun updateUI(Kategori:KategoriBmi){
        ...
        when(Kategori) {
            ...
            KategoriBmi.IDEAL -> {
                ...
                binding.textView.text = getString(R.string.ideal)
            }
            KategoriBmi.GEMUK -> {
                actionBar?.title = getString(R.string.gemuk)
                binding.imageView.setImageResource(R.drawable.gemuk)
                binding.textView.text = getString(R.string.gemuk)
            }
        }
    }
}